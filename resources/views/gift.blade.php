<div class="col-md-2 mt-2 gift-box pb-3">
    <div class="">
        <div class="gift-box-body  wow fadeIn">
            <img class="" style="height:200px;object-fit:cover;width:100%" src="{{  $gift->pic_url }}" />
        ...
        <div class="gift-box-footer">
            ...
            <br />
            <div class="d-flex justify-content-between mt-1 pb-4">
